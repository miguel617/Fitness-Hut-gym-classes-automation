...
def main():
    ...
    def calculate_cron_expression(target_time_str, target_day, target_class, offset_hours, timezone_str):
        ...
        return f'- cron: "{cron_minute} {cron_hour} {cron_day_of_month} {cron_month} {cron_day_of_week}"    # Runs 37 hours less (UTC time) to schedule {target_day} : {target_time_str} - {target_class}'

    cron_expressions = []

    offset_hours = 37  # Offset in hours
